...
const DashboardPage = () => {
  ...
  // Handle event drop (manual drag & drop)
  ...
  return (
    <div className={`dashboard ${isDarkMode ? "dark-mode" : ""}`}>
      ...
      <nav className="navbar">
        ...
        {/* Normal nav buttons; toggled by hamburger in mobile view */}
      ...
      <div className="main-container">
        ...
        <div className="calendar-section">
          <FullCalendar
            ...
            /* Show day names from Sunday to Saturday in short form */
            dayHeaders={true}
